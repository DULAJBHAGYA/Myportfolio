...
const Modal = ({ activeID, setShowModal }) => {
  ...
  return (
    <div className='w-full h-full fixed top-9 left-0 z-10 bg-headingColor bg-opacity-60'>
    <div className='w-11/12  md:max-w-[600px] md:w-full md:h-[85vh] absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px]
        ...
        <div>
            ...
            <div className='mt-2 flex items-center gap-3 flex-wrap'>
                <h4 className='text-headingColor text-[18px] text-[700]'>
                    ...
                    <span 
                    key={index}
                    className='bg-gray-200 py-0.5 px-2 rounded-[5px] text-[14px] leading-0'>
                        {item}
                    </span>
                    )}
            </div>
